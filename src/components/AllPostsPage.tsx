...
const PostCard: React.FC<PostCardProps> = ({ blog }) => {
  ...
  if (commentCount === 0) {
	...
	<div className="post-content ast-grid-common-col">
		<div className="ast-blog-featured-section post-thumb ast-blog-single-element"><div className="post-thumb-img-content post-thumb"><a href="https://kumaromkar.in/3177-2/" aria-label="Read: My&nbsp;First&nbsp;Industry&nbsp;Experience:&nbsp;Internship&nbsp;at&nbsp;DRDO"><img width="800" height="600" src="https://res.cloudinary.com/dk0uj1jry/image/upload/v1763219583/DRDO_RCI_Internship_ze172a.png" className="attachment-800x600 size-800x600" alt="" itemProp="&quot;image&quot;" decoding="async" /></a></div></div><h2 className="entry-title ast-blog-single-element" itemProp="headline"><a href="https://kumaromkar.in/3177-2/" rel="bookmark">My&nbsp;First&nbsp;Industry&nbsp;Experience:&nbsp;Internship&nbsp;at&nbsp;DRDO</a></h2>		<header className="entry-header ast-blog-single-element ast-blog-meta-container">
